...
function showQuote() {
  ...
  const newQuoteQuote = document.createElement('p');
  const newQuoteAuthor = document.createElement('p');
  newQuoteQuote.textContent = randomQuote.quote;
  newQuoteAuthor.textContent = 'By ' + randomQuote.author;
  clearAll();
  container.appendChild(newQuoteQuote);
...
function showRiddle() {
  ...
  riddleAnswer.setAttribute('id', 'answ')
...
function revealAnswers() {
  ...
  if(riddle && answer.hidden){
    answer.hidden = false;
     ...
     alert('Click the Riddle me button to challenge yourself ')
     }
